...
namespace Ex4Balada
{
    ...
    /***********************
        The IF Solution
    ************************/
            if ("sim".Equals (respostaIdade, StringComparison.CurrentCultureIgnoreCase)
             && "sim".Equals (respostaDisponibilidade, StringComparison.CurrentCultureIgnoreCase)) {
                ...
                if ("paguei".Equals (respostaEntrada, StringComparison.CurrentCultureIgnoreCase)
                 || "tenho".Equals (respostaEntrada, StringComparison.CurrentCultureIgnoreCase)) {
